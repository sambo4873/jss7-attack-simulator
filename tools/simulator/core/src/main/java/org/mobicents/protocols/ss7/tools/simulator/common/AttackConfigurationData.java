...
import org.mobicents.protocols.ss7.tools.simulator.level2.AttackSccpConfigurationData;
...
public class AttackConfigurationData extends ConfigurationData {
    ...
    private AttackSccpConfigurationData sccpConfigurationData = new AttackSccpConfigurationData();
    ...
    public AttackSccpConfigurationData getSccpConfigurationData() {
        return sccpConfigurationData;
    }

    public void AttacksetSccpConfigurationData(AttackSccpConfigurationData sccpConfigurationData) {
     ...
     */
    protected static final XMLFormat<AttackConfigurationData> CONFIGURATION_DATA_XML = new XMLFormat<AttackConfigurationData>(
            AttackConfigurationData.class) {

        @Override
        public void read(javolution.xml.XMLFormat.InputElement xml, AttackConfigurationData data) throws XMLStreamException {
        ...
        @Override
        public void write(AttackConfigurationData data, javolution.xml.XMLFormat.OutputElement xml) throws XMLStreamException {
