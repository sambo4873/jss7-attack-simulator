 ...
 */
public class TestSRIForSMServerStandardManMbBean extends StandardMBean {

    public TestSRIForSMServerStandardManMbBean(TestSRIForSMServerMan impl, Class<TestSRIForSMServerManMBean> intf)
    ...
    public MBeanInfo getMBeanInfo() {
        ...
        return new MBeanInfo(TestSRIForSMServerMan.class.getName(), "SRIForSMServer test parameters management", attributes, null,
                operations, null);
    }
}
