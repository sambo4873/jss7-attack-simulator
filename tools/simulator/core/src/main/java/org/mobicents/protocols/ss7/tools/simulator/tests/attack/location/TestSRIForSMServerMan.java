 ...
 */
public class TestSRIForSMServerMan extends TesterBase implements TestSRIForSMServerManMBean, Stoppable, MAPDialogListener, MAPServiceSmsListener {
    public static String SOURCE_NAME = "TestSRIForSMerver";
    ...
    public TestSRIForSMServerMan() {
        super(SOURCE_NAME);
        this.name = "???";
    }

    public TestSRIForSMServerMan(String name) {
        super(SOURCE_NAME);
        this.name = name;
    }
